...
@Entity(tableName = "user-collection_table")
...
fun List<CollectionPOJ>.asUserCollectionEntity():List<UserCollectionEntity>
{
    return map {
...
fun List<UserCollectionEntity>.asUserCollectionDomain():List<CollectionDomain>
{
    return this.map {
        CollectionDomain(
            id=it.id,
